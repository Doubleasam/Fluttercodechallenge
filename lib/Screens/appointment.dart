...
import 'package:doctor_app/Screens/upcoming.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(Icons.home,color: Colors.blue[200],), label: "Home"),
          BottomNavigationBarItem(icon: Icon(Icons.person,color: Colors.blue[200],), label: "Appointments"),
          BottomNavigationBarItem(
              icon: Icon(Icons.account_balance_wallet,color: Colors.blue[200],), label: "Home"),
          BottomNavigationBarItem(icon: Icon(Icons.person,color: Colors.blue[200],), label: "Home")
        ],
      ),
      body: VStack([
        HStack(
        ...
        Row(
          ...
          children: [
            ...
            InkWell(
              onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>DatePage()));
              },
                          child: VxCapsule(
                width: 140,
                height: 50,
        ...
        HStack(
          [
            InkWell(
              ...
              child: "Upcoming Appointments".text.gray500.semiBold.size(18).make()),
            "Past Appointments".text.blue500.semiBold.size(18).make(),
          ],
          alignment: MainAxisAlignment.spaceBetween,
          axisSize: MainAxisSize.max,
        ),
        ...
        VxBox(
          ...
          Icon(
            ...
            .withDecoration(
                BoxDecoration(border: Border.all(color: Vx.gray400)))
            .makeCentered(),
        20.heightBox,
        appointmentCard(),
        10.heightBox,
